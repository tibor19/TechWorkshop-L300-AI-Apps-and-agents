...
import numpy as np
import time
from utils.clients_utils import get_openai_client
...
def generate_response(text_input):
    ...
    # logger.warning(credential.get_token("https://cognitiveservices.azure.com/.default").token)
    ...
    client = get_openai_client(endpoint, deployment, api_key, api_version)

    # Call Azure OpenAI chat API
    completion = client.chat.completions.create(messages=chat_prompt,
        model=deployment,
